...
I'm also an active **open-source contributor with GirlScript Summer of Code (GSSoC)**, and I regularly take part in **hackathons and ideathons** - I like the pressure of a ticking clock and the collaboration that comes with building something from scratch alongside a team. Always an eager learner, always looking for the next thing worth figuring out.
...
open_source: [GirlScript Summer of Code (GSSoC) contributor]
loves: [Hackathons, Ideathons, Team-based building sprints]
...
- 🏁 Thriving in hackathon and ideathon settings where planning and execution both happen fast
